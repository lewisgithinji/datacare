...
import MarketingChatbotAnalytics from "./pages/MarketingChatbotAnalytics"; // New import
import DemoPage from "./pages/DemoPage"; // Demo page import

// Authentication
import ProtectedRoute from "./components/auth/ProtectedRoute"; // Corrected import
import LoginPage from "./pages/auth/LoginPage"; // Corrected import
import SignupPage from "./pages/auth/SignupPage"; // Corrected import
import ForgotPassword from "./pages/auth/ForgotPassword";
import ResetPassword from "./pages/auth/ResetPassword";

// Dashboard
import DashboardLayout from "./pages/dashboard/DashboardLayout"; // Corrected path and import
...
import CampaignsPage from "./pages/dashboard/CampaignsPage"; // Campaigns import // Corrected path and import
  ...
  <HelmetProvider>
    <QueryClientProvider client={queryClient}>
      <TooltipProvider>
        ...
        <BrowserRouter>
          <ScrollToTop />
          <Routes> {/* <--- Re-introduced the <Routes> component */}
            {/* Public routes */}
            ...
            <Route path="/marketing/chatbot-analytics" element={<MarketingChatbotAnalytics />} /> {/* New route */}
            <Route path="/demo" element={<DemoPage />} /> {/* Demo page route */}
            ...
            <Route path="/dashboard/*" element={
              ...
              <Route path="campaigns" element={<CampaignsPage />} /> {/* Swapped to real component */}
